...
class Category(models.Model):
	...
	meta_keywords = models.CharField('Meta Keywords', max_length=255, help_text='Content for description meta tag')
	meta_description = models.CharField(default='meta description', max_length=255, help_text='context for description meta tag')
...
class Product(models.Model):
	...
	image = models.ImageField(upload_to='images/products/main', blank=True, default='images/products/main')
	thumbnail = models.ImageField(upload_to='images/products/thumbnails', blank=True, default='images/products/main')
	...
	#return the products in previous orders
